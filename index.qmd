...
I'm Wenyu Liu (<img class="inline-svg filter-color-to-body" src="./files/wenyu.svg" alt="wenyu Logo"/> <img class="inline-svg filter-color-to-body" src="./files/liu.svg" alt="liu Logo" style="margin-right: 0em"/>), a PhD student in energy at <img class="inline-svg filter-color-to-body" src="./files/epfl-logo.svg" alt="EPFL Logo" style="height: 0.9em"/> École Polytechnique Fédérale de Lausanne (EPFL). 
...
- **2026 - Present** : Doctoral Student in Energy @ [École Polytechnique Fédérale de Lausanne](https://www.epfl.ch/en/)
...
- **04.2026 - Present** : Doctoral Assistant (100%) @ [Distributed Electrical Systems Laboratory](https://www.epfl.ch/labs/desl/)
